...
while(i < instructions.length) {
    ...
    if(instruction === '01') {
        ...
        const inputNum = 5
        instructions[instructions[i+1]] = inputNum
        i += 2
    }
    else if (instruction === '04') {
        const output = opString[2] === '0' ? instructions[instructions[i+1]] :  instructions[i+1]
        console.log(output)
        i+=2
    }
